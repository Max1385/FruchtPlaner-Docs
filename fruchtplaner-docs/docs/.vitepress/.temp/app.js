...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"Mein Discord Bot","description":"Dokumentation fuer meinen Bot","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"nav":[{"text":"Home","link":"/"},{"text":"Guide","link":"/guide/getting-started"}],"sidebar":[{"text":"Guide","items":[{"text":"Getting Started","link":"/guide/getting-started"},{"text":"Commands","link":"/guide/commands"}]}],"search":{"provider":"local"}},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
...
const _sfc_main$s = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.DPynmnPP.js"));
